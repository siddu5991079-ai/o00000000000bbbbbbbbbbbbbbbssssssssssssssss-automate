...
// =========================================================================
// 🛠️ SETUP OBS CONFIGURATION (DYNAMIC QUALITY)
// =========================================================================
function setupOBSConfig() {
    console.log('[*] Generating OBS Config files with WebSocket & Scenes...');
    
    // 🎛️ Quality Dropdown Logic
    const selectedQuality = process.env.STREAM_QUALITY || 'Original (1080p Max)';
    let outWidth = 1920, outHeight = 1080, vBitrate = 5000; // Default (Original)

    if (selectedQuality === '360p') { outWidth = 640; outHeight = 360; vBitrate = 800; }
    else if (selectedQuality === '480p') { outWidth = 854; outHeight = 480; vBitrate = 1500; }
    else if (selectedQuality === '720p') { outWidth = 1280; outHeight = 720; vBitrate = 3000; }
    else if (selectedQuality === '1080p') { outWidth = 1920; outHeight = 1080; vBitrate = 4500; }
    else { outWidth = 1920; outHeight = 1080; vBitrate = 6000; } // Original High Quality

    console.log(`[📺] Applying Stream Quality: ${selectedQuality} (${outWidth}x${outHeight} @ ${vBitrate}kbps)`);
    ...
    // Yahan humne Base (Screen) 1080p rakha hai, aur Output (Stream) dynamic kar diya hai
...
async function startDirectStreaming() {
    ...
    browser = await puppeteer.launch({
        ...
        args: [
            ...
            '--window-size=1920,1080', '--window-position=0,0', '--kiosk', '--start-fullscreen',
...
// # ************************ Alhamdullah sab teek hai bas upper yeh qulaity wala option add karty hai taakey high quality bey hu and yeh below code mei yeh keyaa pata kahaa par video 2 sec k stop huty hai and audio chal raha huta hai and pher video =====================
